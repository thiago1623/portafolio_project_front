...
const ModalGoalsAndHabits = ({ token, isOpen, openModal, languages, sendUpdatedLanguages}) => {
...
export default connect(mapStateToProps, { sendUpdatedLanguages })(ModalGoalsAndHabits)
